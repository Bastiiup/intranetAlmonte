/**
 * API Route para servir PDFs de listas desde Strapi con autenticación
 * GET /api/crm/listas/pdf/[pdfId]
 */
...
/**
 * GET /api/crm/listas/pdf/[pdfId]
 * Obtiene un PDF de lista desde Strapi Media Library y lo sirve con autenticación
 */
export async function GET(
  ...
  try {
    ...
    if (!response.ok) {
      console.error('[API /crm/listas/pdf/[pdfId] GET] Error al obtener PDF:', {
    ...
    if (!pdfResponse.ok) {
      console.error('[API /crm/listas/pdf/[pdfId] GET] Error al obtener archivo PDF:', {
    ...
    return new NextResponse(pdfBuffer, {
      ...
      headers: {
        ...
        'Content-Disposition': `inline; filename="${fileData.name || 'lista.pdf'}"`,
    ...
    console.error('[API /crm/listas/pdf/[pdfId] GET] Error:', error)
    return NextResponse.json(
