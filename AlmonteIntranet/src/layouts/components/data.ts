...
export const menuItems: MenuItemType[] = [
  ...
  { key: 'logs', label: 'Registro de Auditoría', icon: LuFileText, url: '/logs', roles: ['super_admin'] },
  { key: 'equipos-section', label: 'EQUIPOS', isTitle: true },
  {
    ...
    icon: LuUsers,
    children: [
      { key: 'colaboradores', label: 'Colaboradores', url: '/colaboradores', roles: ['super_admin', 'supervisor'] },
      { key: 'colaboradores-solicitudes', label: 'Solicitudes de Colaboradores', url: '/colaboradores/solicitudes', roles: ['super_admin'] },
      { key: 'profile', label: 'Perfil', url: '/users/profile', roles: ['super_admin', 'supervisor', 'soporte'] },
    ],
  },
