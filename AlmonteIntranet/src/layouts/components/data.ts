...
export const menuItems: MenuItemType[] = [
  { key: 'comercial', label: 'COMERCIAL', isTitle: true },
  {
    ...
    children: [
      ...
      { key: 'crm-empresas', label: 'Empresas', url: '/crm/empresas' },
      ...
      { key: 'crm-rfqs', label: 'Solicitudes de Cotización', url: '/crm/compras/rfqs' },
      { key: 'crm-cotizaciones-recibidas', label: 'Cotizaciones Recibidas', url: '/crm/compras/cotizaciones' },
      { key: 'crm-ordenes-compra', label: 'Órdenes de Compra', url: '/crm/compras/ordenes-compra' },
