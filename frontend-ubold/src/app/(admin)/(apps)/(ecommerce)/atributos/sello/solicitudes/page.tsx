...
import SolicitudesSellosListing from './components/SolicitudesSellosListing'
...
export default async function Page() {
  ...
  try {
    ...
    // TODO: Crear endpoint /api/tienda/sello/solicitudes cuando esté listo
    ...
    if (data.success && data.data) {
      // Por ahora usar los sellos como solicitudes hasta que tengamos el endpoint específico
  ...
  return (
    <Container fluid>
      ...
      <SolicitudesSellosListing solicitudes={solicitudes} error={error} />
    </Container>
  )
}
