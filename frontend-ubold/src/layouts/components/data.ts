    ...
    children: [
      ...
      { key: 'etiqueta-requests', label: 'Solicitudes de Etiquetas', url: '/products/etiquetas/solicitudes', roles: ['super_admin', 'encargado_adquisiciones', 'supervisor'] },
      {
        ...
        children: [
          ...
          { key: 'autor-requests', label: 'Solicitudes de Autores', url: '/atributos/autores/solicitudes', roles: ['super_admin', 'encargado_adquisiciones', 'supervisor'] },
          ...
          { key: 'obra-requests', label: 'Solicitudes de Obras', url: '/atributos/obras/solicitudes', roles: ['super_admin', 'encargado_adquisiciones', 'supervisor'] },
