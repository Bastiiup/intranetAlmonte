...
- `INVESTIGACION-ERROR-REGION-URGENTE.md` - Investigación completa
- `PROMPT-ERROR-REGION-PERSISTENTE.md` - Documento de problema persistente
...
- **Frontend:** Filtrado completo de `region` en `/api/persona-trayectorias/route.ts`
- **Backend Strapi:** Protecciones en controller y lifecycle hook
- **Schema:** Solo existe `colegio_region`, NO `region`
