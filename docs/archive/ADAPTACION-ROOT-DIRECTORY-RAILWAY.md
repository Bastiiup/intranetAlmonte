...
- [Railway Documentation - Root Directory](https://docs.railway.app/develop/railway-json#rootdirectory)
- [Railway Documentation - Build Configuration](https://docs.railway.app/develop/railway-json#build)
- [Docker Documentation - COPY instruction](https://docs.docker.com/reference/dockerfile/#copy)

---

**Última actualización**: Diciembre 2025  
**Rama donde se aplicaron los cambios**: `refinar-Gonza` (o la rama actual)
